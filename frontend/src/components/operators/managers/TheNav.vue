<template>
    ...
    <div v-else id="nav-manager" class="d-flex flex-column justify-content-between">
      <div id="stock" class="d-flex" @mouseleave="mouseLeaveStock">
        ...
        <div id="stock-list" class="flex-fill d-flex nav_bg novisible">
          ...
          <div class="flex-fill text-center ps-3 pe-2 lh-7" aria-label="Nouveau stock">
      ...
      <div id="cash-register" class="d-flex" @mouseleave="mouseLeaveCR">
          ...
          <div id="cash-register--list" class="flex-fill d-flex align-items-center ps-2 nav_bg novisible">
              <div class="flex-fill align-self-center text-center lh-7" aria-label="Caisse 1">
                  <font-awesome-icon :icon="['fas', 'cash-register']" /><span class="fw-bold lh-7"> 1</span></div>
                <div class="flex-fill text-center" aria-label="Caisse 2">
                  <font-awesome-icon :icon="['fas', 'cash-register']" /><span class="fw-bold"> 2</span></div>
                <div class="flex-fill text-center" aria-label="Caisse 3">
                  <font-awesome-icon :icon="['fas', 'cash-register']" /><span class="fw-bold"> 3</span></div>
      ...
      <div id="contact" class="d-flex" @mouseleave="mouseLeaveContact">
          ...
          <div id="contact--list" class="flex-fill d-flex ps-2 nav_bg novisible">
              <div class="flex-fill text-center lh-7" aria-label="Clients">
                  <font-awesome-icon :icon="['fas', 'user']" /></div>
                <div class="flex-fill text-center lh-7" aria-label="Fournisseurs">
                  <font-awesome-icon :icon="['fas', 'truck']" /></div>
                <div class="flex-fill text-center lh-7" aria-label="Entreprise">
                  <font-awesome-icon :icon="['fas', 'building']" /></div>
              </div>
              </div>
      <!-- <div
            class="dropend align-self-start red"
           >
            <button
              id="stock-button--md"
              type="button"
            ...
            <ul class="dropdown-menu nav_bg">
              <li class="nav-color d-flex flex-row p-0 lh1">
                <div class="flex-fill" aria-label="Stock en cours">
                  <router-link
                          :to="{
                            name: 'TheStock',
                            params: {
                          ...
                          class="fw-bold text-center ps-2 autoclose"
                ...
                <div class="flex-fill text-center" aria-label="Nouveau stock">
                  <font-awesome-icon :icon="['fas', 'calendar-plus']" />
                </div>
                <div class="flex-fill responsabilities">  
                         <form class="d-flex justify-content-between">
                          <div class="responsabilities-input">
                           <input id="week" type="week" name="week" class="nav_bg fw-bold">      
                          </div>
                         <button class="nav_bg" type="submit">
                <font-awesome-icon
                  :icon="['fas', 'circle-check']"
                  aria-label="Valider semaine"
                />
...
export default {
  ...
  methods: {
    ...
    showCR() {
      document.getElementById('cash-register--list').classList.toggle('novisible')
