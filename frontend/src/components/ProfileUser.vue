      ...
      <form class="d-flex flex-column" @submit.prevent="submit">
        <div class="mb-auto formulaire d-flex flex-wrap">
          ...
          />
              ...
              <label for="society" class="form-label text-fonce">Société (facultatif)</label>
              <input
              id="society"
              ...
              <label for="cp" class="form-label text-fonce"><span class="desktop">Code postal</span><span class="mobile">CP</span></label>
              <input
              id="cp"
              v-model="form.cp"
              type="text"
              ...
              <div class="mb-auto w45">
              <label for="billing_address" class="form-label text-fonce">Addresse de facturation (facultatif)</label>
              <input
              id="billing_address"
              ...
              <div class="mb-auto ms-auto w10">
              <label for="billing_cp" class="form-label text-fonce"><span class="desktop">Code postal</span><span class="mobile">CP</span></label>
              <input
              id="billing_cp"
              ...
              <div class="mb-auto w45">
              <label for="delivery_address" class="form-label text-fonce">Addresse de livraison (facultatif)</label>
              <input
              id="delivery_address"
              ...
              <div class="mb-auto ms-auto w10">
              <label for="delivery_cp" class="form-label text-fonce"><span class="desktop">Code postal</span><span class="mobile">CP</span></label>
              <input
              id="delivery_cp"
...
v-show="!updated"
        ...
        <button
              type="button" class="flex-fill btn btn-danger fw-bold border-end"
              @click="deleteProfil()">
              Supprimer le profil
          </button>
        <button
              type="button" class="flex-fill btn btn-danger fw-bold"
...
export default {
  ...
  methods: {
    ...
    async deleteProfil() {
      await AuthService.deleteContactMe()
        .then(result => { 
          if(result)  {  
...
@media #{$desktop-up} {
  .title {
      ...
      form {
        ...
        .btn-warning, .btn-success, .btn-delete {
          height: 9vh;
          width: 50%;
        }
      }
...
.border-button {
  border-right: lighten($danger, 15%) 3px solid !important;
}
//Pour desktop
@media #{$desktop-up} {
  section {
...
@media #{$mobile-up} {
  section {
    ...
    button {
      border-bottom: lighten($danger, 15%) 3px solid !important;
    }
    .legend {
      text-align: center;
    }
