    ...
    <div class="footer">
      <div class="row">
        ...
        <div class="col-lg-3 col-sm-1 col-1">
          ...
          >
            <div v-if="!mobile">Mentions légales</div>
            <div v-else aria-label="Mentions légales" class="f-size">
              <font-awesome-icon
                :icon="['fas', 'book']"
